...
export function AdminSidebar({
  ...
  const resolvedOwnerId =
    propOwnerId || searchParams.get("owner") || user?.uid || "";
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "p-6 pb-2 transition-all duration-300 flex items-center justify-between",
              ...
              {currentWs ? (
                <>
                  {currentWs.settings?.logo ? (
                    <img
                      src={currentWs.settings.logo}
                      alt={currentWs.name}
                      className="w-8 h-8 rounded-lg object-contain bg-white border border-[var(--border-color)] text-[var(--text-muted)] shrink-0"
                    />
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor: currentWs.settings?.color || "#3b82f6",
                      }}
                    >
                  ...
                  <div className="flex flex-col items-start min-w-0">
                    ...
                    <span className="text-sm font-black text-[var(--text-main)] truncate w-full">
                      {currentWs.name}
                    </span>
                  </div>
                </>
            ...
            <div className="max-h-64 overflow-y-auto p-2 space-y-1">
              {allWorkspaces.map((ws) => (
                ...
                >
                  {ws.settings?.logo ? (
                    <img
                      src={ws.settings.logo}
                      alt={ws.name}
                      className="w-8 h-8 rounded-lg object-contain bg-white border border-[var(--border-color)] shrink-0"
                    />
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor: ws.settings?.color || "#3b82f6",
                      }}
                    >
              ...
              >
                ...
                <span className="text-sm font-bold text-[var(--text-muted)] group-hover:text-blue-600 transition-colors">
                  Create Workspace
                </span>
              </button>
            </div>
      ...
      <div className="p-4 mt-auto relative" ref={userMenuRef}>
        <div
          className={cn(
            ...
            !isCollapsed &&
              "bg-[var(--bg-main)] rounded-[20px] border border-[var(--border-color)] p-2",
        ...
        >
          <button
            ...
            className={cn(
              "flex items-center gap-3 w-full text-left rounded-xl transition-colors",
