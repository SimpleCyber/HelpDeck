...
export function MessageBubble({
  ...
  return (
    <div
      className={cn(
        "flex flex-col group animate-in fade-in slide-in-from-bottom-2 duration-500 helpdeck-widget",
    ...
    >
      ...
      >
        {message.text.startsWith("data:image") ? (
          ...
          <div className="px-5 py-3.5 text-sm font-medium leading-relaxed tracking-tight">
            {message.text}
          </div>
        )}
      </div>
