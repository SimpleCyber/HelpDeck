...
function WidgetContent({ workspaceId }: { workspaceId: string }) {
  ...
  return (
    <>
      ...
      {isOpen ? (
        <div className="fixed  w-[380px] h-[640px] bg-[#fafafa] rounded-[1rem] flex flex-col overflow-hidden pointer-events-auto animate-in slide-in-from-bottom-6 transition-all duration-500 ease-out">
